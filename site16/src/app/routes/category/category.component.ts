...
export class CategoryComponent {
  breadItems: BreadItem[] = [
    ...
    {
      title: this.cat.openedCategoryTitle,
    }
  ];
  title = this.cat.openedCategoryTitle;
        ...
        `
{
  ...
  "url": "${SiteURL()}/category/${this.cat.openedCategorySlug}"
}
`;
  ...
  setSEO() {
    ...
    this.setCanonicalURL(`${SiteURL()}/category/${this.cat.openedCategorySlug}`);
    ...
    this.meta.addTags([
      ...
      { property: 'og:url', content: `${SiteURL()}/category/${this.cat.openedCategorySlug}` },
  ...
  loadMore(nt: boolean = true) {
    ...
    this.isLoading = true;
    this.cont.loadPostsByCategory(this.loadedIndex, this.cat.openedCategory, r => {
