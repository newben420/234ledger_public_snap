import { Component, ElementRef, ViewChild, Renderer2, ViewContainerRef, ComponentRef, Inject, PLATFORM_ID } from '@angular/core';
...
export class PromptComponent {
  ...
  constructor(
    ...
    this.subs = promptService.prompts.subscribe((prmpts: any) => {
      if (prmpts.operation == "add" && this.isBrowser && this.myCont) {
